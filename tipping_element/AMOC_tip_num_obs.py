...
if __name__=='__main__':
    yth=0.99
    with open('../data/amoc/tip_num.csv','w',encoding='utf-8') as f:
        steps=10000
        dt=0.1
        ...
        y_ini=0.2
        for r_obs in [0.025,0.05,0.1,0.2]:
            s_obs=r_obs*10
            ...
            for obs_num,fs in [[11,200],[21,100],[41,50],[81,25],[101,20],[201,10]]:
                ...
                for seed in range(1,101,1):
                    ...
                    obs_steps=[int(gap/dt)+t*fs for t in range(obs_num)]
