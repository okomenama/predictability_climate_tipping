...
data_path='../data/final_result/amoc/tip_num_amp4_n.csv'
no_obs_data_path='../data/final_result/amoc/tip_num_non_obs_amp4_n.csv'
...
for i,group in group_data:
    ...
    plt.savefig(
        '../../output/final_result/amoc/scenario_amp4_n/group_{}_{}_{}.png'.format(
            group.iat[0,0],group.iat[0,1],group.iat[0,2]))
    plt.close()
    plt.clf()
...
plt.savefig(
    '../../output/final_result/amoc/scenario_amp4_n/all_hist_1.png')
plt.close()
plt.clf()
...
plt.savefig(
    '../../output/final_result/amoc/scenario_amp4_n/all_hist_2.png')
plt.close()
plt.clf()
...
plt.savefig(
    '../../output/final_result/amoc/scenario_amp4_n/all_hist_3.png')
plt.close()
plt.clf()
...
plt.savefig('../../output/final_result/amoc/scenario_amp4_n/group1_accuracy_mean_map.png')
plt.close()
plt.clf()
##group1 mvar
plt.figure()
...
plt.savefig('../../output/final_result/amoc/scenario_amp4_n/group1_accuracy_var_map.png')
plt.close()
plt.clf()
##group2 mean
plt.figure()
...
plt.savefig('../../output/final_result/amoc/scenario_amp4_n/group2_accuracy_mean_map.png')
plt.close()
plt.clf()
##group2 var
plt.figure()
...
plt.savefig('../../output/final_result/amoc/scenario_amp4_n/group2_accuracy_var_map.png')
plt.close()
plt.clf()
##group3 mean
plt.figure()
...
plt.savefig('../../output/final_result/amoc/scenario_amp4_n/group3_accuracy_mean_map.png')
plt.close()
plt.clf()
##group3 var
plt.figure()
...
plt.savefig('../../output/final_result/amoc/scenario_amp4_n/group3_accuracy_var_map.png')
plt.close()
plt.clf()