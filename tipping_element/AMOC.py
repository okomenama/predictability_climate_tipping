...
if __name__=='__main__':
    ...
    ax1.set_xlabel('yr')
    ax1.set_ylabel('Q')
    ax1.plot(T,np.percentile(Q2_results,25,axis=0),color='gray',linestyle='solid')
    ax1.plot(T,np.percentile(Q2_results,75,axis=0),color='gray',linestyle='solid')
    ax1.scatter(T[obs_steps],Q_obs[obs_steps],color='blue',linestyle='solid')
    ax1.plot(T,Q2_obs_nonnoise,color='black',linestyle='solid')
    ax1.plot(T,Q2_results.mean(axis=0),color='red')
    ...
    ax1.set_xlabel('yr')
    ax1.set_ylabel('Q')
    ax1.plot(T,np.percentile(Q3_results,25,axis=0),color='gray',linestyle='solid')
    ax1.plot(T,np.percentile(Q3_results,75,axis=0),color='gray',linestyle='solid')
    ax1.scatter(T[obs_steps],Q_obs[obs_steps],color='blue',linestyle='solid')
    ax1.plot(T,Q3_obs_nonnoise,color='black',linestyle='solid')
    ax1.plot(T,Q3_results.mean(axis=0),color='red')
    ax1.vlines((obs_num+1)*fs*dt+gap,0,20,color='y', linestyle='dotted')
    ...
    ax2.set_xlabel('yr')
    ax2.set_ylabel('y')
    ax2.plot(T,np.percentile(y_results,25,axis=0),color='gray',linestyle='solid')
    ax2.plot(T,np.percentile(y_results,75,axis=0),color='gray',linestyle='solid')
    ...
    ax2.set_xlabel('yr')
    ax2.set_ylabel('y')
    ax2.plot(T,np.percentile(y2_results,25,axis=0),color='gray',linestyle='solid')
    ax2.plot(T,np.percentile(y2_results,75,axis=0),color='gray',linestyle='solid')
    ...
    ax2.set_xlabel('yr')
    ax2.set_ylabel('y')
    ax2.plot(T,np.percentile(y3_results,25,axis=0),color='gray',linestyle='solid')
    ax2.plot(T,np.percentile(y3_results,75,axis=0),color='gray',linestyle='solid')
    ...
    ax3.plot(T,np.percentile(ita_results,25,axis=0),color='gray',linestyle='solid')
    ax3.plot(T,np.percentile(ita_results,75,axis=0),color='gray',linestyle='solid')
    ...
    ax4.plot(T,np.min(mu_results,axis=0),color='gray',linestyle='solid')
    ax4.plot(T,np.percentile(mu_results,25,axis=0),color='gray',linestyle='solid')
    ax4.plot(T,np.percentile(mu_results,75,axis=0),color='gray',linestyle='solid')
    ax4.plot(T,np.min(mu_results,axis=0),color='gray',linestyle='solid')
